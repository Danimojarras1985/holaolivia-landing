export function ProcessTitleAndSubtitleContainer() {
  return (
    ...
    >
      ...
      Credflow acompaña a tu cliente en cada paso: explica opciones, reúne documentos, radica el crédito en varios bancos a la vez y te mantiene al tanto de todo.
      </p>
    </div>
  );
}
