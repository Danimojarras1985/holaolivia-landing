...
const cards = [
  {
    question: "¿Qué es Credflow?",
    answer:
      "Credflow es un asistente con inteligencia artificial que atiende a tus clientes por WhatsApp, los guía en su proceso de crédito y te mantiene informado en cada paso.",
  },
  {
    question: "¿Qué hace exactamente Credflow?",
    answer:
      "Contacta por WhatsApp, explica opciones con lenguaje sencillo, resuelve dudas, solicita la documentación necesaria por partes y radica la solicitud de crédito ante el banco en varios bancos a la vez.",
  },
  {
  ...
  {
    question: "¿Cuánto cuesta usar Credflow?",
    answer:
      "No tiene costo fijo para el broker. Tu comisión del crédito se respeta; el modelo de Credflow se basa en acuerdos de comisión del crédito con los aliados financieros.",
  },
  {
  ...
  {
    question: "¿En qué bancos opera Credflow?",
    answer:
